        ...
        <motion.div
          ...
          className="flex-[0.5] lg:max-w-[370px] flex justify-center flex-col gradient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative">
            ...
            <p className="mt-[24px] font-normal sm:text-[18px] text-[12px] sm:leading-[45px] leading-[39px] text-white">
              "With the development of today's technology, metaverse is very useful for today's work, or can be called web 3.0. by using metaverse yu can use it as anything.."
            </p>
        </motion.div>
        <motion.div
